...
--*****************************************************************
-- Script Name: NG_NIS_PUB_ADMIN_MASTER_SCRIPT_3.4.4.0
--
-- Purpose: NextGen NISSAN v3.4.4.0 Script (for PUB_ADMIN) 
--
--*****************************************************************
-- Revision History
...
----->>>>METADATA
\ir  '../pub_admin/metadata/pba_param_t.sql'
\ir  '../pub_admin/metadata/dr_datasrc_t.sql'
