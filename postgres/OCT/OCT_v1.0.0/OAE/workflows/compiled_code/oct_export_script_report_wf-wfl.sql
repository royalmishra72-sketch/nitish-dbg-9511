...
declare
    ...
    Exported on:   2024-07-31 01:57:52-04
...
$afcompiler$
begin
perform af_repo.fk_add_context('oct_export_script_report_wf'::varchar,'W'::varchar, 180::smallint, '(1.7.3.8)This workflow use to export scripts from pba server.'::varchar, 1::integer, 'gj5701'::varchar);
perform af_repo.fk_add_step('Start'::varchar, 20::integer, 'output_version'::varchar, ''::varchar, 'main_10'::varchar, ''::varchar, ''::varchar, '    output_version'::varchar, 'oct_export_script_report_wf'::varchar, 'W'::varchar, 1::integer, 'gj5701'::varchar);
perform af_repo.fk_add_step('main_10'::varchar, 21::integer, 'output_options'::varchar, ''::varchar, 'main_20'::varchar, ''::varchar, ''::varchar, '    output_options'::varchar, 'oct_export_script_report_wf'::varchar, 'W'::varchar, 1::integer, 'gj5701'::varchar);
perform af_repo.fk_add_step('main_20'::varchar, 22::integer, 'set'::varchar, ':tag_area|~|SD'::varchar, 'main_30'::varchar, ''::varchar, ''::varchar, '    set :tag_area = "SD"'::varchar, 'oct_export_script_report_wf'::varchar, 'W'::varchar, 1::integer, 'gj5701'::varchar);
perform af_repo.fk_add_step('main_30'::varchar, 23::integer, 'set'::varchar, ':tag_other|~|OCT'::varchar, 'main_40'::varchar, ''::varchar, ''::varchar, '    set :tag_other = "OCT"'::varchar, 'oct_export_script_report_wf'::varchar, 'W'::varchar, 1::integer, 'gj5701'::varchar);
perform af_repo.fk_add_step('main_40'::varchar, 25::integer, 'load'::varchar, ':exception_handler_email|~|select pub_admin.get_parameter(''OCT'')::jsonb->>''email_to'' AS email_to'::varchar, 'main_50'::varchar, ''::varchar, ''::varchar, '    load :exception_handler_email = "select pub_admin.get_parameter(''OCT'')::jsonb->>''email_to'' AS email_to"	'::varchar, 'oct_export_script_report_wf'::varchar, 'W'::varchar, 1::integer, 'gj5701'::varchar);
perform af_repo.fk_add_step('main_50'::varchar, 26::integer, 'load'::varchar, ':script_path|~|select root||script.get_parameter||''OCT/'' from pub_admin.get_parameter(''PBAEnvRootPath'') root cross join (select pub_admin.get_parameter(''PATH_COMMON_SCRIPT'')) script'::varchar, 'main_60'::varchar, ''::varchar, ''::varchar, '    load :script_path="select root||script.get_parameter||''OCT/'' from pub_admin.get_parameter(''PBAEnvRootPath'') root cross join (select pub_admin.get_parameter(''PATH_COMMON_SCRIPT'')) script"'::varchar, 'oct_export_script_report_wf'::varchar, 'W'::varchar, 1::integer, 'gj5701'::varchar);
perform af_repo.fk_add_step('main_60'::varchar, 28::integer, 'load'::varchar, ':input_directory|~|SELECT case when ''&&v_input_directory&&''=''DEFAULT'' then pub_admin.get_parameter(''OCT'')::jsonb->>''root_directory'' else ''&&v_input_directory&&'' end AS root_directory'::varchar, 'main_70'::varchar, ''::varchar, ''::varchar, '    load :input_directory= "SELECT case when ''&&v_input_directory&&''=''DEFAULT'' then pub_admin.get_parameter(''OCT'')::jsonb->>''root_directory'' else ''&&v_input_directory&&'' end AS root_directory"'::varchar, 'oct_export_script_report_wf'::varchar, 'W'::varchar, 1::integer, 'gj5701'::varchar);
perform af_repo.fk_add_step('main_70'::varchar, 29::integer, 'load'::varchar, ':csv_file_path|~|select pub_admin.get_parameter(''OCT'')::jsonb->>''root_directory'''::varchar, 'main_80'::varchar, ''::varchar, ''::varchar, '    load :csv_file_path= "select pub_admin.get_parameter(''OCT'')::jsonb->>''root_directory''"'::varchar, 'oct_export_script_report_wf'::varchar, 'W'::varchar, 1::integer, 'gj5701'::varchar);
perform af_repo.fk_add_step('main_80'::varchar, 30::integer, 'load'::varchar, ':sender_email|~|select ''&&system_user&&@snapon.com'''::varchar, 'main_90'::varchar, ''::varchar, ''::varchar, '    load :sender_email= "select ''&&system_user&&@snapon.com''"'::varchar, 'oct_export_script_report_wf'::varchar, 'W'::varchar, 1::integer, 'gj5701'::varchar);
perform af_repo.fk_add_step('main_90'::varchar, 31::integer, 'load'::varchar, ':recipient_email|~|select pub_admin.get_parameter(''OCT'')::jsonb->>''email_to'' AS email_to'::varchar, 'main_100'::varchar, ''::varchar, ''::varchar, '    load :recipient_email= "select pub_admin.get_parameter(''OCT'')::jsonb->>''email_to'' AS email_to"'::varchar, 'oct_export_script_report_wf'::varchar, 'W'::varchar, 1::integer, 'gj5701'::varchar);
perform af_repo.fk_add_step('main_100'::varchar, 32::integer, 'load'::varchar, ':exclude_subdirs|~|select case when ''&&v_exclude_subdirs&&''=''DEFAULT'' then pub_admin.get_parameter(''OCT'')::jsonb->>''skip_folder_ls'' else concat(pub_admin.get_parameter(''OCT'')::jsonb->>''skip_folder_ls'','','',''&&v_exclude_subdirs&&'') end as skip_folder_ls'::varchar, 'main_110'::varchar, ''::varchar, ''::varchar, '    load :exclude_subdirs= "select case when ''&&v_exclude_subdirs&&''=''DEFAULT'' then pub_admin.get_parameter(''OCT'')::jsonb->>''skip_folder_ls'' else concat(pub_admin.get_parameter(''OCT'')::jsonb->>''skip_folder_ls'','','',''&&v_exclude_subdirs&&'') end as skip_folder_ls"'::varchar, 'oct_export_script_report_wf'::varchar, 'W'::varchar, 1::integer, 'gj5701'::varchar);
perform af_repo.fk_add_step('main_110'::varchar, 33::integer, 'load'::varchar, ':exclude_file_list|~|select case when ''&&v_exclude_files&&''=''DEFAULT'' then pub_admin.get_parameter(''OCT'')::jsonb->>''skip_file_ls'' else concat(pub_admin.get_parameter(''OCT'')::jsonb->>''skip_file_ls'','','',''&&v_exclude_files&&'') end as skip_file_ls'::varchar, 'main_120'::varchar, ''::varchar, ''::varchar, '    load :exclude_file_list= "select case when ''&&v_exclude_files&&''=''DEFAULT'' then pub_admin.get_parameter(''OCT'')::jsonb->>''skip_file_ls'' else concat(pub_admin.get_parameter(''OCT'')::jsonb->>''skip_file_ls'','','',''&&v_exclude_files&&'') end as skip_file_ls"'::varchar, 'oct_export_script_report_wf'::varchar, 'W'::varchar, 1::integer, 'gj5701'::varchar);
perform af_repo.fk_add_step('main_120'::varchar, 34::integer, 'load'::varchar, ':exclude_file_pattern|~|select case when ''&&v_exclude_file_patterns&&''=''DEFAULT'' then pub_admin.get_parameter(''OCT'')::jsonb->>''skip_file_patterns'' else concat(pub_admin.get_parameter(''OCT'')::jsonb->>''skip_file_patterns'','','',''&&v_exclude_file_patterns&&'') end as skip_file_pattern'::varchar, 'main_130'::varchar, ''::varchar, ''::varchar, '    load :exclude_file_pattern= "select case when ''&&v_exclude_file_patterns&&''=''DEFAULT'' then pub_admin.get_parameter(''OCT'')::jsonb->>''skip_file_patterns'' else concat(pub_admin.get_parameter(''OCT'')::jsonb->>''skip_file_patterns'','','',''&&v_exclude_file_patterns&&'') end as skip_file_pattern"'::varchar, 'oct_export_script_report_wf'::varchar, 'W'::varchar, 1::integer, 'gj5701'::varchar);
perform af_repo.fk_add_step('main_130'::varchar, 35::integer, 'load'::varchar, ':db_name|~|select upper(concat(split_part(current_database(),''_'',1)||''_''||split_part(current_database(),''_'',3)||''_''||split_part(current_database(),''_'',4)))'::varchar, 'main_140'::varchar, ''::varchar, ''::varchar, '    load :db_name= "select upper(concat(split_part(current_database(),''_'',1)||''_''||split_part(current_database(),''_'',3)||''_''||split_part(current_database(),''_'',4)))"'::varchar, 'oct_export_script_report_wf'::varchar, 'W'::varchar, 1::integer, 'gj5701'::varchar);
perform af_repo.fk_add_step('main_140'::varchar, 36::integer, 'load'::varchar, ':hash_comparable_file_pattern_list|~|select pub_admin.get_parameter(''OCT'')::jsonb->>''hash_comparable_file_pattern'''::varchar, 'main_150'::varchar, ''::varchar, ''::varchar, '    load :hash_comparable_file_pattern_list = "select pub_admin.get_parameter(''OCT'')::jsonb->>''hash_comparable_file_pattern''"	'::varchar, 'oct_export_script_report_wf'::varchar, 'W'::varchar, 1::integer, 'gj5701'::varchar);
perform af_repo.fk_add_step('main_150'::varchar, 37::integer, 'run'::varchar, '&&script_path&&oct_script_export.py &&input_directory&& &&csv_file_path&& &&sender_email&& &&recipient_email&& &&exclude_subdirs&& &&exclude_file_list&& &&exclude_file_pattern&& &&db_name&& &&hash_comparable_file_pattern_list&&'::varchar, 'main_160'::varchar, ''::varchar, ''::varchar, '    run &&script_path&&oct_script_export.py &&input_directory&& &&csv_file_path&& &&sender_email&& &&recipient_email&& &&exclude_subdirs&& &&exclude_file_list&& &&exclude_file_pattern&& &&db_name&& &&hash_comparable_file_pattern_list&&'::varchar, 'oct_export_script_report_wf'::varchar, 'W'::varchar, 1::integer, 'gj5701'::varchar);
perform af_repo.fk_add_step('main_160'::varchar, 38::integer, 'output_options'::varchar, ''::varchar, 'Done'::varchar, ''::varchar, ''::varchar, '    output_options'::varchar, 'oct_export_script_report_wf'::varchar, 'W'::varchar, 1::integer, 'gj5701'::varchar);
