...
--*****************************************************************
-- Script Name: NG_NIS_CTRG_MASTER_SCRIPT_3.4.4.1
--
-- Purpose: NextGen NISSAN v3.4.4.1 Script (for CTRG) 
--
--*****************************************************************
-- Revision History
--   Ref #  Date              Revisor       Comment
--   1      14-Aug-2026      NKM           Initial Version 
--*****************************************************************
-- Revisor
-- [Initials]		    [Full Name]
...
----->>Pub Code Version Update 
\ir  '../ctrg/metadata/dataset_property.sql'
